...
function peg$parse(input, options) {
  ...
  function peg$f0(pointer) {return {pointer};  }
  function peg$f1(pointer) {return {pointer};  }
  ...
  function peg$parseExpression() {
    ...
    if (s0 === peg$FAILED) {
      s0 = peg$parseAttributeValueTemplate();
    }
  ...
  function peg$parseAttributeValueTemplate() {
    let s0, s1;
